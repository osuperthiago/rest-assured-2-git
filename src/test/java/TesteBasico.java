...
public void createBooking() throws IOException {
    ...
    given()
            ...
            .then()
            .statusCode(200)
            .body("booking.firstname", equalTo("Thi"))
            .body("booking.lastname", equalTo("Thi"))
            .body("booking.totalprice", equalTo(666))
            .body("booking.depositpaid", is(true))
            .body("booking.bookingdates.checkin", equalTo("2025-01-01"))
            .body("booking.bookingdates.checkout", equalTo("2026-01-01"))
